<section class="wrapper">
    <div class="table-agile-info">
        <div class="panel panel-default">
            ...
            $sql = "SELECT * FROM sanpham WHERE Loai = 2 AND DaXoa = 0";
            ...
            <script>
                ...
                function confirmDelete(newProductId) {
                ...
                function deleteNewProduct(newProductId) {
                    window.location.href = "../../NewProduct/delete_new_product.php?id=" + newProductId;
                }
            </script>
        </div>
    </div>
