                            ...
                            if (isset($_GET['id'])) {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ?>
                                        <div class="card">
                                            <img src="<?php echo $row["HinhAnh"]; ?>" class="card-img-top" alt="Product Image">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo $row["TenSP"]; ?></h5>
                                                <p class="card-text">Product Id: <?php echo $row["MaSP"]; ?></p>
                                                <!-- Xuất các thông tin khác của sản phẩm tương ứng -->
                                ...
                                if (isset($_POST['delete'])) {
                                    ...
                                    // Thực hiện truy vấn để xóa sản phẩm từ CSDL
                                    // Code truy vấn dựa vào loại CSDL bạn đang sử dụng
                                    // Ở đây, tôi sử dụng MySQLi làm ví dụ
                                    ...
                                    // Chuẩn bị câu truy vấn SQL để xóa sản phẩm dựa vào id
                                    $deleteSql = "DELETE FROM sanpham WHERE MaSP = $productIdToDelete";
