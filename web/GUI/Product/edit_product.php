                    ...
                    <div class="panel panel-default">
                        ...
                        <center>
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                // Thực hiện truy vấn để lấy thông tin của sản phẩm từ CSDL
                                // Code truy vấn dựa vào loại CSDL bạn đang sử dụng
                                // Ở đây, tôi sử dụng MySQLi làm ví dụ
                                ...
                                // Chuẩn bị câu truy vấn SQL để lấy thông tin của sản phẩm dựa vào id
                                ...
                                if ($result->num_rows > 0) {
                                    // Lặp qua từng hàng kết quả và xuất thông tin sản phẩm
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productImage" name="productImage"
                                                    value="<?php echo $row["HinhAnh"]; ?>"><br>
                                                <img id="productImagePreview" src="<?php echo $row["HinhAnh"]; ?>"
                                                    alt="Product Image" style="max-width: 300px;"><br>
                                            </div>
                                            <!-- Tương tự, thêm các trường nhập liệu cho các thông tin sản phẩm khác -->
                                        ...
                                        if (isset($_POST['update'])) {
                                            ...
                                            // Chuẩn bị câu truy vấn SQL để cập nhật thông tin sản phẩm
                                            $updateSql = "UPDATE sanpham SET TenSP='$productName', HinhAnh='$productImage' WHERE MaSP=$productId";

                                            // Thực hiện truy vấn cập nhật
                                            if ($conn->query($updateSql) === TRUE) {
                                                echo "<p class='text-success'>Cập nhật sản phẩm thành công.</p>";
                                                echo "<script>window.location.href = '../Layout/_LayoutView/LayoutView.php?act=Product';</script>";
                                            } else {
                                                echo "<p class='text-danger'>Lỗi khi cập nhật sản phẩm: " . $conn->error . "</p>";
                                            }
                                        }
                                    }
                                } else {
